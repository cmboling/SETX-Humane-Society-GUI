...
public class LostPetUI extends JFrame {
   JFrame frmLostPetApplication;
   JPanel panel;
   private JTextField fname,lname,city,state,zip,hphone,cphone,wphone,email; 
   private JLabel FNameL,LNameL,CityL,StateL,ZipL,HphoneL,CphoneL,WphoneL,EmailL,LostPetInfoL;
   private JButton btnBack;
   private JButton btnExit;
   private JTextField lostpetinfo;
   
   public LostPetUI() {
	   getContentPane().setLayout(new GridLayout(12, 2));
	   frmLostPetApplication =new JFrame("Adoption Application");
	   frmLostPetApplication.setTitle("Lost Pet Application");
       ...
       LostPetInfoL = new JLabel("Description of Lost Pet");
       LostPetInfoL.setHorizontalAlignment(SwingConstants.CENTER);
       LostPetInfoL.setBounds(28, 337, 146, 43);
       panel.add(LostPetInfoL);
       ...
       btnSubmit.addActionListener(new ActionListener() {
       	public void actionPerformed(ActionEvent e) {
       	            ...
       	            try {
       	                writer = new BufferedWriter(new FileWriter("LostPetApplicants.txt",true));
       	                ...
       	                writer.write(fname.getText() + "\t" + lname.getText() + "\t" + city.getText() + "\t" + state.getText() + "\t" + hphone.getText() +
       	                		"\t" + cphone.getText() + "\t" + wphone.getText() + "\t" + email.getText()+ "\t" + lostpetinfo.getText());
       	                writer.newLine();
       	                writer.close();
       ...
       lostpetinfo = new JTextField();
       lostpetinfo.setBounds(195, 334, 644, 60);
       panel.add(lostpetinfo);
       lostpetinfo.setColumns(10);
